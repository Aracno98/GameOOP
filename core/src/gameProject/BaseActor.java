...
public class BaseActor extends Group {
	...
	/**
	 * Set deceleration of this object. Deceleration is only applied when object is
	 * not accelerating.
	 * 
	...
	/**
	 * Set the speed of movement (in pixels/second) in current direction. If current
	 * speed is zero (direction is undefined), direction will be set to 0 degrees.
	 * 
	 ...
	 * 
	 * @param dt Time elapsed since previous frame (delta time); typically obtained
	 *           from the act method.
	 */
	 ...
	 * instances exist, returns an empty list.
	 * 
