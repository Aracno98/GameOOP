 ...
 * Add support for textures/animation, collision polygons, movement, world boundaries and camera scrolling. 
 * @author Alex Reami
 */
public class BaseActor extends Group {
	 ...
	 *  @param dt Time elapsed since previous frame (delta time); typically obtained from the act method.
	 */
